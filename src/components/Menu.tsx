  ...
  return (
    <>
      <header className='header'>
        <button className={`button-nav ${!toggle ? 'btn-active-border' : ''}`} onClick={handleClickActive}>
          <div className='cont-buton'>
            <img src={logo} className='logo' />
            <img src={arrow} alt="arrow" style={{ marginTop: '10px' }} className={`arrow ${toggle ? 'activo' : ''}`} />
          </div>
        </button>
